...
void SapXepChanTangDan(int a[][MAX], int dong, int cot)
{
...
void SapXepLeGiamDan(int a[][MAX], int dong, int cot)
{
    int i, j, Start1, Start2, d = 0;
    for(int i = 0; i < dong; i++)
    {
...
void SapXepChanTangDanLeGiamDan(int a[][MAX], int dong, int cot)
{
